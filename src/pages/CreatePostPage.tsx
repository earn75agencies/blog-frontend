...
const CreatePostPage = () => {
  ...
  const onSubmit = async (data: PostFormData) => {
    setIsLoading(true);
    try {
      const post = await postService.createPost(data, featuredImageFile || undefined);
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="card">
        <h1 className="text-3xl font-bold mb-6">{t('post.createPost')}</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            >
              {isLoading ? <LoadingSpinner size="sm" /> : t('common.create')}
            </button>
            <button
              type="button"
